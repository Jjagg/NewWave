...
namespace NewWave.Core.Scales
{
	public static class ScaleLibrary
	{
		...
		public static OctavePitch Step(Pitch root, ScaleType scaleType, OctavePitch start, int steps)
		{
			var startPitch = start.FromOctavePitch();
			...
			return scale[returnIndex].ToOctavePitch(returnOctave);
		}
	}
}
