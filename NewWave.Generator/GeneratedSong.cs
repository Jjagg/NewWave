...
namespace NewWave.Generator
{
	public class GeneratedSong : Song
	{
		...
		public override Score Render()
		{
			...
			var renderedSections = Sections.Select(s => s.Render(_songInfo.Parameters.GuitarStrummer(s.Type), _songInfo.Parameters.DrumStyle(), guitarR, guitarL, guitarC, guitarLc, guitarRc, bass, drums));
